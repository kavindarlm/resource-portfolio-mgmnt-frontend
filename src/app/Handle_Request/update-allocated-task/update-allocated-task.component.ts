...
@Component({
  selector: 'app-update-allocated-task',
  templateUrl: './update-allocated-task.component.html',
  styleUrl: './update-allocated-task.component.css'
})
export class UpdateAllocatedTaskComponent implements OnInit {
  resourceId: string = '';
  sprintId: string = '';
  resourceDetails: any = {};
  tasks: any[] = [];
